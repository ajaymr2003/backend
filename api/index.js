...
// =========================================================================
// === NEW ENDPOINT #1: To check for a pending navigation request
// =========================================================================
...
// =========================================================================
// === NEW ENDPOINT #2: To clear a navigation request after it starts
// =========================================================================
app.post('/api/end-navigation', async (req, res) => {
    ...
    try {
        const navRef = db.collection('navigation').doc(email);
        // Set isNavigating and isRunning to false to clean up the state.
        await navRef.update({
            isNavigating: false,
            isRunning: false
        });
        ...
        // If the document doesn't exist, it's not a critical error.
        if (error.code === 5) { // Firestore's 'NOT_FOUND' error code
